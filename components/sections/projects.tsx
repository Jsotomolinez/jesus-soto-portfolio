...
export default function Projects() {
  const isVisible = useVisibility("projects");

  return (
    <section
      className={`py-12 md:py-24 lg:py-32 transition-opacity duration-1500 ease-initial ${isVisible ? "opacity-100" : "opacity-0"}`} id="projects">
