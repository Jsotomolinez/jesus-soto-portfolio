    ...
    >
      <div className="mx-auto flex max-w-[980px] flex-col items-center gap-4 text-center">
        ...
        <p className="max-w-[700px] text-lg text-muted-foreground">
          Soy un estudiante de ingeniería química en la universidad de Carabobo. Me le apasiona la programación y el desarrollo de software. 
        ...
        <p className="max-w-[700px] text-lg text-muted-foreground">
          Formé parte del instituto de búsqueda y salvamento (I-SAR) durante 4 años en donde enfrenté todo tipo de situaciones,
           desde rescates en montaña hasta siniestros viales o incluso simplemente hacer que una persona se sienta segura en su peor momento.
          <br /> <br /> 
        </p>
